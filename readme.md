...
| `Encrypt` | No | `false` | Encrypt the connection with TLS. Off by default so that a local server connects; a hosted PostgreSql such as Supabase or Neon requires it on. |
